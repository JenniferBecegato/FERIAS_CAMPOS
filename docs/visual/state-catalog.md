...
|---|---|
| Normal | superfície branca, borda neutra |
| Hover | fundo `#F1F7FE` e cursor de ação |
| Selecionado | azul suave, realce azul primário |
| Foco | contorno azul de 2 px, navegação por teclado |
| Carregando | skeleton sem alterar a geometria |
| Vazio | mensagem contextual e ação principal |
| Erro | vermelho, mensagem junto ao campo e resumo acessível |
